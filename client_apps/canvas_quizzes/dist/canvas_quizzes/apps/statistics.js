...
(function() {
  ...
  "map": {
    ...
    "canvas_quizzes/config": {
      "app": "canvas_quizzes/apps/statistics"
    }
  },
  "bundles": {
    "canvas_quizzes": [
...
define('canvas_quizzes/apps/statistics/config',['require','canvas_quizzes/config'],function(require) {
...
define('canvas_quizzes/apps/statistics/config/initializers/rsvp',[ 'rsvp' ], function(RSVP) {
...
define('canvas_quizzes/apps/statistics/config/initializers/backbone',['require','../../config','canvas_quizzes/core/adapter','backbone'],function(require) {
...
define('canvas_quizzes/apps/statistics/config/initializer',['require','./initializers/rsvp','./initializers/backbone'],function(require) {
...
define('canvas_quizzes/apps/statistics/core/dispatcher',['require','canvas_quizzes/core/dispatcher','../config'],function(require) {
...
define('canvas_quizzes/apps/statistics/constants',{
...
define('canvas_quizzes/apps/statistics/models/quiz_statistics',['require','backbone','canvas_quizzes/models/common/pick_and_normalize','../constants','lodash','canvas_quizzes/util/array_wrap','canvas_quizzes/util/round','i18n!quiz_statistics'],function(require) {
  var Backbone = require('backbone');
...
define('canvas_quizzes/apps/statistics/collections/quiz_statistics',['require','backbone','../models/quiz_statistics','canvas_quizzes/models/common/from_jsonapi','../config'],function(require) {
  var Backbone = require('backbone');
...
define('canvas_quizzes/apps/statistics/stores/common/populate_collection',[],function() {
  /**
...
define('canvas_quizzes/apps/statistics/stores/statistics',['require','canvas_quizzes/core/store','../core/dispatcher','../config','../collections/quiz_statistics','./common/populate_collection'],function(require) {
...
define('canvas_quizzes/apps/statistics/models/quiz_report',['require','backbone','canvas_quizzes/models/common/pick_and_normalize','../constants','canvas_quizzes/models/common/from_jsonapi'],function(require) {
  var Backbone = require('backbone');
  var pickAndNormalize = require('canvas_quizzes/models/common/pick_and_normalize');
  var K = require('../constants');
  var fromJSONAPI = require('canvas_quizzes/models/common/from_jsonapi');
...
define('canvas_quizzes/apps/statistics/collections/quiz_reports',['require','backbone','../models/quiz_report','canvas_quizzes/models/common/from_jsonapi','../config','canvas_quizzes/core/adapter'],function(require) {
  var Backbone = require('backbone');
...
define('canvas_quizzes/apps/statistics/services/poll_progress',['require','rsvp','jquery','canvas_quizzes/core/adapter','../constants','../config','canvas_quizzes/models/common/pick_and_normalize'],function(require) {
...
define('canvas_quizzes/apps/statistics/stores/reports',['require','canvas_quizzes/core/store','../core/dispatcher','../config','../constants','../collections/quiz_reports','../services/poll_progress','./common/populate_collection'],function(require) {
  var Store = require('canvas_quizzes/core/store');
  var Dispatcher = require('../core/dispatcher');
  var config = require('../config');
  var K = require('../constants');
...
define('canvas_quizzes/apps/statistics/stores/notifications',['require','canvas_quizzes/core/store','../core/dispatcher','lodash'],function(require) {
  var Store = require('canvas_quizzes/core/store');
  var Dispatcher = require('../core/dispatcher');
  var _ = require('lodash');
...
define('canvas_quizzes/apps/statistics/core/controller',['require','../stores/statistics','../stores/reports','../stores/notifications','../config'],function(require) {
...
define('canvas_quizzes/apps/statistics/actions',['require','./core/dispatcher'],function(require) {
  var Dispatcher = require('./core/dispatcher');
  var Actions = {};
...
define('canvas_quizzes/apps/statistics/views/notifications',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../actions','i18n!quizzes'],function(require) {
  ...
  var Notifications = React.createClass({displayName: 'Notifications',
    ...
    render: function() {
      return(
        React.DOM.ul({'aria-relevant': "additions", 'aria-live': "assertive", id: "notifications"}, 
    ...
    renderNotification: function(notification) {
      ...
      return (
        React.DOM.li({key: notification.id}, 
          React.DOM.div({className: "notification"}, 
...
define('canvas_quizzes/apps/statistics/util/format_number',[ '../config' ], function(config) {
  /**
   * @member Util
   * @method formatNumber
   *
...
define('canvas_quizzes/apps/statistics/mixins/chart',['require','old_version_of_react_used_by_canvas_quizzes_client_apps'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
...
define('canvas_quizzes/apps/statistics/views/summary/score_percentile_chart',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../../mixins/chart','d3','i18n!quiz_statistics.summary'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
...
define('canvas_quizzes/apps/statistics/mixins/components/actor',['require','../../core/dispatcher'],function(require) {
  var Dispatcher = require('../../core/dispatcher');
...
define('canvas_quizzes/apps/statistics/ext/react',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../mixins/components/actor'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
...
define('canvas_quizzes/apps/statistics/models/quiz_report_descriptor',['require','i18n!quiz_reports','canvas_quizzes/util/date_time_helpers'],function(require) {
...
define('canvas_quizzes/apps/statistics/views/summary/report/status',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','i18n!quiz_reports','../../../constants','../../../models/quiz_report_descriptor','../../../actions'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var I18n = require('i18n!quiz_reports');
  var K = require('../../../constants');
        ...
        React.DOM.div({className: "auxiliary"}, 
          React.DOM.p(null, 
            ...
            React.DOM.span({'aria-hidden': "true"}, 
              ...
              ' ', 
              cancelable &&
                React.DOM.a({href: "#", onClick: this.cancel}, I18n.t('cancel_generation', 'Cancel'))
...
define('canvas_quizzes/components/popup',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','jquery','lodash','qtip','./screen_reader_content'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var $ = require('jquery');
  var _ = require('lodash');
...
define('canvas_quizzes/apps/statistics/views/summary/report',['require','../../ext/react','jquery','./report/status','canvas_quizzes/components/popup','canvas_quizzes/components/screen_reader_content','canvas_quizzes/components/sighted_user_content','../../models/quiz_report_descriptor'],function(require) {
  var React = require('../../ext/react');
  var $ = require('jquery');
  var Status = require('./report/status');
  var Popup = require('canvas_quizzes/components/popup');
  ...
  var Report = React.createClass({displayName: 'Report',
    ...
    renderDownloader: function() {
      ...
      return(
        React.DOM.a({href: this.props.file.url, className: "btn download-report"}, 
          ScreenReaderContent({children: srLabel}), 
...
define('canvas_quizzes/components/spinner',['require','old_version_of_react_used_by_canvas_quizzes_client_apps'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
...
define('canvas_quizzes/apps/statistics/views/summary/section_select',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../../stores/statistics','../../config','i18n!quiz_statistics'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var quizStatistics = require('../../stores/statistics');
  var config = require('../../config');
  var I18n = require('i18n!quiz_statistics');
  ...
  var SectionLink = React.createClass({displayName: 'SectionLink',
    ...
    render: function() {
      return (
        React.DOM.li({role: "presentation", onClick: this.handleClick}, 
          React.DOM.a({href: "#", id: "toolbar-2", role: "menuitem"}, this.props.name)
        )
      );
    }
  });
  ...
  var SectionSelect = React.createClass({displayName: 'SectionSelect',
    ...
    render: function() {
      ...
      return(
        React.DOM.div({className: "section_selector inline al-dropdown__container"}, 
          React.DOM.a({className: "al-trigger btn", role: "button", href: "#"}, 
            sectionTitle, 
             React.DOM.i({className: "icon-mini-arrow-down", 'aria-hidden': "true"}), 
             React.DOM.span({className: "screenreader-only"}, I18n.t('Section Filter'))
           ), 
          React.DOM.ul({
            id: "toolbar-1", 
...
define('canvas_quizzes/apps/statistics/views/summary',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','i18n!quiz_statistics.summary','canvas_quizzes/util/seconds_to_time','canvas_quizzes/util/round','../util/format_number','./summary/score_percentile_chart','./summary/report','canvas_quizzes/components/sighted_user_content','canvas_quizzes/components/screen_reader_content','canvas_quizzes/components/spinner','./summary/section_select'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var I18n = require('i18n!quiz_statistics.summary');
  var secondsToTime = require('canvas_quizzes/util/seconds_to_time');
  var round = require('canvas_quizzes/util/round');
  var formatNumber = require('../util/format_number');
  var ScorePercentileChart = require('./summary/score_percentile_chart');
  var Report = require('./summary/report');
  var SightedUserContent = require('canvas_quizzes/components/sighted_user_content');
  var ScreenReaderContent = require('canvas_quizzes/components/screen_reader_content');
  var Spinner = require('canvas_quizzes/components/spinner');
  var NA_LABEL = I18n.t('not_available_abbrev', 'N/A');
  var SectionSelect = require('./summary/section_select');
...
define('canvas_quizzes/apps/statistics/views/question',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','canvas_quizzes/util/class_set'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  ...
  var Question = React.createClass({displayName: 'Question',
    render: function() {
      ...
      return(
        React.DOM.div({key: this.props.position, className: className, children: this.props.children})
      );
    }
  });
...
define('canvas_quizzes/apps/statistics/views/questions/header',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','i18n!quiz_statistics','canvas_quizzes/components/screen_reader_content'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var I18n = require('i18n!quiz_statistics');
  var ScreenReaderContent = require('canvas_quizzes/components/screen_reader_content');
...
define('canvas_quizzes/apps/statistics/views/charts/correct_answer_donut',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','d3','../../mixins/chart','canvas_quizzes/util/round','i18n!quiz_statistics'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var d3 = require('d3');
  var ChartMixin = require('../../mixins/chart');
  var round = require('canvas_quizzes/util/round');
...
define('canvas_quizzes/components/dialog',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','jqueryui/dialog','jquery','lodash','../constants'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var jQueryUIDialog = require('jqueryui/dialog');
  var $ = require('jquery');
  var _ = require('lodash');
  var K = require('../constants');
  var omit = _.omit;
  ...
  var Dialog = React.createClass({displayName: 'Dialog',
    ...
    /**
     * @private Send an API command to the jQueryUI Dialog instance.
     *
...
define('canvas_quizzes/components/text',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','lodash','../util/i18n_interpolate','../util/convert_case'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var _ = require('lodash');
...
define('canvas_quizzes/apps/statistics/views/charts/discrimination_index/help',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../../../constants','canvas_quizzes/components/text','i18n!quiz_statistics'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var K = require('../../../constants');
  var Text = require('canvas_quizzes/components/text');
  var I18n = require('i18n!quiz_statistics');
...
define('canvas_quizzes/apps/statistics/views/charts/discrimination_index',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','../../constants','i18n!quiz_statistics.discrimination_index','canvas_quizzes/util/class_set','canvas_quizzes/components/dialog','canvas_quizzes/components/screen_reader_content','canvas_quizzes/components/sighted_user_content','./discrimination_index/help','../../util/format_number'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var K = require('../../constants');
  var I18n = require('i18n!quiz_statistics.discrimination_index');
  var classSet = require('canvas_quizzes/util/class_set');
  var Dialog = require('canvas_quizzes/components/dialog');
  var ScreenReaderContent = require('canvas_quizzes/components/screen_reader_content');
  var SightedUserContent = require('canvas_quizzes/components/sighted_user_content');
  var Help = require('./discrimination_index/help');
  var formatNumber = require('../../util/format_number');
        ...
        React.DOM.section({className: "discrimination-index-section"}, 
          React.DOM.div(null, 
            SightedUserContent(null, 
              ...
              React.DOM.p(null, I18n.t('discrimination_index', 'Discrimination Index'), 
                Dialog({
                  tagName: "button", 
...
define('canvas_quizzes/apps/statistics/views/questions/user_list_dialog',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','canvas_quizzes/components/dialog','i18n!quiz_statistics'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var Dialog = require('canvas_quizzes/components/dialog');
  var I18n = require('i18n!quiz_statistics');

  var UserListDialog = React.createClass({displayName: 'UserListDialog',
    getDefaultProps: function() {
      return {
        answer_id: 0,
        user_names: []
    ...
    userList: function(){
      return(
        React.DOM.div({key: 'answer-users-'+this.props.answer_id}, 
          React.DOM.ul({className: "answer-response-list"}, 
            this.props.user_names.map(function(user_name, i) {
              return(React.DOM.li({key: i}, user_name));
            })
...
define('canvas_quizzes/apps/statistics/views/questions/answer_table/answer_row',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','lodash','i18n!quiz_statistics.answers_tables','./../user_list_dialog'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var _ = require('lodash');
  var I18n = require('i18n!quiz_statistics.answers_tables');
  var UserListDialog = require('./../user_list_dialog');
...
define('canvas_quizzes/apps/statistics/views/questions/answer_table',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','d3','lodash','./answer_table/answer_row','i18n!quiz_statistics.answer_table'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var d3 = require('d3');
  var _ = require('lodash');
  var AnswerRow = require('./answer_table/answer_row');
  var I18n = require("i18n!quiz_statistics.answer_table");

  var SPECIAL_DATUM_IDS = [ 'other', 'none' ];

  var AnswerTable = React.createClass({displayName: 'AnswerTable',
    ...
    render: function() {
      ...
      return (
        React.DOM.table({className: "answer-drilldown-table detail-section"}, 
          React.DOM.caption({className: "screenreader-only"}, 
    ...
    renderTableHeader: function() {
      ...
      return (
        React.DOM.thead({className: "screenreader-only"}, 
          React.DOM.tr(null, 
            React.DOM.th({scope: "col"}, firstColumnLabel), 
            React.DOM.th({scope: "col"}, I18n.t("Number of Respondents")), 
            React.DOM.th({scope: "col"}, I18n.t("Percent of respondents selecting this answer")), 
            React.DOM.th({scope: "col", 'aria-hidden': true}, I18n.t("Answer Distribution"))
          )
        )
      );
    },
...
define('canvas_quizzes/apps/statistics/models/ratio_calculator',[],function() {
...
define('canvas_quizzes/apps/statistics/views/questions/multiple_choice',['require','../../ext/react','../question','./header','../charts/correct_answer_donut','../charts/discrimination_index','./answer_table','../../models/ratio_calculator'],function(require) {
  var React = require('../../ext/react');
  var Question = require('../question');
  var QuestionHeader = require('./header');
  var CorrectAnswerDonut = require('../charts/correct_answer_donut');
  var DiscriminationIndex = require('../charts/discrimination_index');
  var AnswerTable = require('./answer_table');
...
define('canvas_quizzes/apps/statistics/views/questions/short_answer',['require','../../ext/react','../question','../charts/correct_answer_donut','../charts/discrimination_index','./answer_table','../../models/ratio_calculator','./header'],function(require) {
  var React = require('../../ext/react');
  var Question = require('../question');
  var CorrectAnswerDonut = require('../charts/correct_answer_donut');
  var DiscriminationIndex = require('../charts/discrimination_index');
...
define('canvas_quizzes/apps/statistics/views/questions/fill_in_multiple_blanks',['require','../../ext/react','i18n!quiz_statistics','../question','./header','../charts/correct_answer_donut','./answer_table','../../models/ratio_calculator','canvas_quizzes/util/round','canvas_quizzes/util/class_set'],function(require) {
  var React = require('../../ext/react');
  var I18n = require('i18n!quiz_statistics');
  var Question = require('../question');
  var QuestionHeader = require('./header');
...
define('canvas_quizzes/apps/statistics/views/questions/essay',['require','../../ext/react','../question','./header','i18n!quiz_statistics','./answer_table'],function(require) {
  var React = require('../../ext/react');
  var Question = require('../question');
  // var CorrectAnswerDonut = require('../charts/correct_answer_donut');
  var QuestionHeader = require('./header');
...
define('canvas_quizzes/apps/statistics/views/questions/calculated',['require','../../ext/react','./essay'],function(require) {
  var React = require('../../ext/react');
...
define('canvas_quizzes/apps/statistics/views/questions/file_upload',['require','../../ext/react','./essay','i18n!quiz_statistics'],function(require) {
  var React = require('../../ext/react');
  var Essay = require('./essay');
  var I18n = require('i18n!quiz_statistics');
  ...
  var FileUpload = React.createClass({displayName: 'FileUpload',
    ...
    renderLinkButton: function() {
      return (
        React.DOM.a({className: "btn", href: this.props.quizSubmissionsZipUrl, target: "_blank", style: {marginBottom: "20px", maxWidth: "50%"}}, 
...
define('canvas_quizzes/apps/statistics/views/app',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','lodash','i18n!quiz_statistics','./notifications','canvas_quizzes/components/screen_reader_content','canvas_quizzes/components/sighted_user_content','./summary','./summary/report','./question','./questions/multiple_choice','./questions/short_answer','./questions/fill_in_multiple_blanks','./questions/essay','./questions/calculated','./questions/file_upload'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var _ = require('lodash');
  var I18n = require('i18n!quiz_statistics');
  ...
  var Report = require('./summary/report');
  var QuestionRenderer = require('./question');
  var MultipleChoiceRenderer = require('./questions/multiple_choice');
  var ShortAnswerRenderer = require('./questions/short_answer');
  var FillInMultipleBlanksRenderer = require('./questions/fill_in_multiple_blanks');
  var EssayRenderer = require('./questions/essay');
  var CalculatedRenderer = require('./questions/calculated');
  var FileUploadRenderer = require('./questions/file_upload');
  ...
  var Statistics = React.createClass({displayName: 'Statistics',
    ...
    render: function() {
      ...
      if (!this.props.canBeLoaded) {
        return(
          React.DOM.div({id: "canvas-quiz-statistics", className: "canvas-quiz-statistics-noload"}, 
            React.DOM.div({id: "sad-panda"}, 
              React.DOM.img({src: "/images/sadpanda.svg", 
...
define('canvas_quizzes/apps/statistics/core/delegate',['require','old_version_of_react_used_by_canvas_quizzes_client_apps','lodash','../config','../config/initializer','./controller','../views/app'],function(require) {
  var React = require('old_version_of_react_used_by_canvas_quizzes_client_apps');
  var _ = require('lodash');
  var config = require('../config');
  var initialize = require('../config/initializer');
  var controller = require('./controller');
  var Layout = require('../views/app');
  var extend = _.extend;
  var container;
  var layout;
...
define('canvas_quizzes/apps/statistics/main',['require','./config','./core/delegate'],function(require) {
  var config = require('./config');
 ...
 */
define('canvas_quizzes/apps/statistics/config/environments/production',{
  /**
...
define("canvas_quizzes/apps/statistics", [ "canvas_quizzes/apps/statistics/main" ], function(boot) {
  return boot;
});
